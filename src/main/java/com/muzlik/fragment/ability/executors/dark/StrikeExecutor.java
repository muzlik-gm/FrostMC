...
public class StrikeExecutor implements AbilityExecutor {
    @Override
    public void execute(AbilityContext context) {
        ...
        // Sound effect - deeper at higher ranks
        float pitch = 0.8f - (rank * 0.05f);
        eyeLoc.getWorld().playSound(eyeLoc, Sound.ENTITY_WITHER_SHOOT, 1.0f + (rank * 0.2f), pitch);
    }
}